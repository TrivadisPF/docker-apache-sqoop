...
RUN curl -s https://downloads.apache.org/sqoop/${APACHE_SQOOP_VERSION}/sqoop-${APACHE_SQOOP_VERSION}.bin__hadoop-${APACHE_SQOOP_HADOOP_VERSION}.tar.gz | tar -xz -C /usr/local
